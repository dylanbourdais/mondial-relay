...
form.addEventListener("submit", async (e)=>{
    ...
    if (params.Ville === "" && params.CP !== "") {
        const rep = await axios.get(`http://localhost:3000/api/search/${params.Pays}/cp/${params.CP}?rayon=${params.RayonRecherche}&results=${params.NombreResultats}`);
        console.log(rep);
    } else if (params.Ville !== "" && params.CP === "") {
        const rep = await axios.get(`http://localhost:3000/api/search/${params.Pays}/ville/${params.Ville}?rayon=${params.RayonRecherche}&results=${params.NombreResultats}`);
        console.log(rep);
    }
});
